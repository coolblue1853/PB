...
namespace MoreMountains.CorgiEngine
{
	...
	/// </summary>
	[AddComponentMenu("Corgi Engine/Character/Abilities/SkillManager_F")]
	public class SkillManager_F : CharacterAbility
	{
		...
		{
			// 
			if ((_inputManager.SkillFButton.State.CurrentState == MMInput.ButtonStates.ButtonDown) || (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonDown))
			{
				canIntrupted = false;
				ShootStart();
			}
			...
			if (CurrentWeapon != null)
			{
				if (ContinuousPress && (CurrentWeapon.TriggerMode == Weapon.TriggerModes.Auto) && (_inputManager.SkillFButton.State.CurrentState == MMInput.ButtonStates.ButtonDown))
				{
					ShootStart();
				}
				if (ContinuousPress && (CurrentWeapon.TriggerMode == Weapon.TriggerModes.Auto) && (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonDown))
				{
					ShootStart();
				}
			}
			...
			if ((_inputManager.SkillFButton.State.CurrentState == MMInput.ButtonStates.ButtonUp) || (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonUp))
			{
				ShootStop();
			}
			...
			if (CurrentWeapon != null)
			{
				if ((CurrentWeapon.WeaponState.CurrentState == Weapon.WeaponStates.WeaponDelayBetweenUses)
					&& ((_inputManager.ShootAxis == MMInput.ButtonStates.Off) && (_inputManager.SkillFButton.State.CurrentState == MMInput.ButtonStates.Off)))
				{
