...
namespace MoreMountains.CorgiEngine
{
	...
	/// </summary>
	[AddComponentMenu("Corgi Engine/Character/Abilities/SkillManager_D")]
	public class SkillManager_D : CharacterAbility
	{
		...
		{
			// 
			if ((_inputManager.SkillDButton.State.CurrentState == MMInput.ButtonStates.ButtonDown) || (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonDown))
			{
				canIntrupted = false;
				ShootStart();
			}
			...
			if (CurrentWeapon != null)
			{
				if (ContinuousPress && (CurrentWeapon.TriggerMode == Weapon.TriggerModes.Auto) && (_inputManager.SkillDButton.State.CurrentState == MMInput.ButtonStates.ButtonDown))
				{
					ShootStart();
				}
			...
			if ((_inputManager.SkillDButton.State.CurrentState == MMInput.ButtonStates.ButtonUp) || (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonUp))
			{
				ShootStop();
			}
			...
			if (CurrentWeapon != null)
			{
				if ((CurrentWeapon.WeaponState.CurrentState == Weapon.WeaponStates.WeaponDelayBetweenUses)
					&& ((_inputManager.ShootAxis == MMInput.ButtonStates.Off) && (_inputManager.SkillDButton.State.CurrentState == MMInput.ButtonStates.Off)))
				{
