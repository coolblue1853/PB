...
namespace MoreMountains.CorgiEngine
{
	...
	/// </summary>
	[AddComponentMenu("Corgi Engine/Character/Abilities/SkillManager_E")]
	public class SkillManager_E : CharacterAbility
	{
		...
		{
			// 
			if ((_inputManager.SkillEButton.State.CurrentState == MMInput.ButtonStates.ButtonDown) || (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonDown))
			{
				canIntrupted = false;
				ShootStart();
			}
			...
			if (CurrentWeapon != null)
			{
				if (ContinuousPress && (CurrentWeapon.TriggerMode == Weapon.TriggerModes.Auto) && (_inputManager.SkillEButton.State.CurrentState == MMInput.ButtonStates.ButtonDown))
				{
					ShootStart();
				}
			...
			if ((_inputManager.SkillEButton.State.CurrentState == MMInput.ButtonStates.ButtonUp) || (_inputManager.ShootAxis == MMInput.ButtonStates.ButtonUp))
			{
				ShootStop();
			}
			...
			if (CurrentWeapon != null)
			{
				if ((CurrentWeapon.WeaponState.CurrentState == Weapon.WeaponStates.WeaponDelayBetweenUses)
					&& ((_inputManager.ShootAxis == MMInput.ButtonStates.Off) && (_inputManager.SkillEButton.State.CurrentState == MMInput.ButtonStates.Off)))
				{
